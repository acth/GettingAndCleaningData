...
#Unzip the file. The archive put the files in a folder named UCI HAR Dataset. Set this folder as the input path. List the files here.
...
#Read the files: Read the subject files.
...
###Use descriptive activity names. Read activity_labels.txt file. This will be used to add descriptive names to the activities.
